...
public class Fragment_Parent extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ContactView = inflater.inflate(R.layout.fragment_parent, container, false);


        post_list = new ArrayList<>();

        mHealthList = (RecyclerView)  ContactView.findViewById(R.id.parent_list);
        ...
        query.orderByChild("stt").startAt(1).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if (post.getTitle().equals("parent")){post_list.add(post);}
